...
**v0.3.0** — three ingestion formats, Contact 360 (Risk + Timeline + Banks + Assets + Work), exact and name+partial-DOB merge suggestions, JSContact Card export (identity + contact points; banks / vehicles / work stay out of Card). See [docs/07-ROADMAP/Roadmap.md](07-ROADMAP/Roadmap.md).
