...
**v0.4.0** — three ingestion formats, Contact 360 (Risk + Timeline + Banks + Assets + Work), exact and name+partial-DOB merge suggestions, reversible merge undo from Timeline, JSContact Card export (identity + contact points; banks / vehicles / work stay out of Card). See [docs/07-ROADMAP/Roadmap.md](07-ROADMAP/Roadmap.md).
