...
- Optional application-level AES-GCM on `STORE_RAW_REPORTS` blobs and IdentityDocument numbers (HMAC of `numberNorm`); later: `pg_trgm` for fuzzy FIO; optional `pgvector`
